...
int main() {
    ...
    // Shader config
    std::filesystem::path shaderAbsPath = std::filesystem::absolute("../resources/shaders/");
    ...
    // load models
    std::filesystem::path backpackAbsPath = std::filesystem::absolute("../resources/models/backpack/");
    std::filesystem::path cubeAbsPath = std::filesystem::absolute("../resources/models/cube/");
    std::filesystem::path chessboardAbsPath = std::filesystem::absolute("../resources/models/chess/");
    ...
    glm::vec4 lightColor = {0.8f, 0.5f, 0.0f, 1.0f};
    ...
    unsigned char *data = stbi_load(std::filesystem::absolute("../resources/textures/grass.jpg").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
