...
int main() {
    ...
    unsigned int diffuseMap = loadTexture((std::filesystem::absolute("./textures/") / "container2.png").c_str());
    unsigned int specularMap = loadTexture((std::filesystem::absolute("./textures/") / "container2_specular.png").c_str());
